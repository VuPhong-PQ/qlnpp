    ...
    },
    {
      ...
      items: [
        ...
        { 
          ...
          resourceKey: 'orders',
          submenu: [
            { name: 'Tạo đơn hàng', path: '/business/sales/sale-management-by-current-user', resourceKey: 'sale_management' },
            { name: 'Quản lý bán hàng', path: '/business/sales/sale-management', resourceKey: 'order_management' },
