...
const XuatNhapTon = () => {
  ...
  const defaultColumns = [
    { id: 'soPhieu', label: 'Số phiếu', width: 120, visible: true, align: 'left' },
    { id: 'ngayLap', label: 'Ngày lập', width: 120, visible: true, align: 'left' },
    { id: 'customerName', label: 'Tên khách hàng', width: 180, visible: true, align: 'left' },
    { id: 'productCode', label: 'Mã hàng', width: 120, visible: true, align: 'left' },
    { id: 'barcode', label: 'Mã vạch', width: 130, visible: true, align: 'left' },
    { id: 'productName', label: 'Tên hàng', width: 240, visible: true, align: 'left' },
    { id: 'unit', label: 'ĐVT', width: 80, visible: true, align: 'center' },
    { id: 'quantity', label: 'Số lượng', width: 100, visible: true, align: 'right' },
    { id: 'giaNhap', label: 'Giá nhập', width: 120, visible: true, align: 'right' },
    { id: 'giaTriNhap', label: 'Giá trị nhập', width: 140, visible: true, align: 'right' },
    { id: 'tienVanChuyen', label: 'Tiền vận chuyển', width: 140, visible: true, align: 'right' },
    { id: 'thanhTienVanChuyen', label: 'Thành tiền vận chuyển', width: 160, visible: true, align: 'right' },
    { id: 'donBan', label: 'Đơn bán', width: 120, visible: true, align: 'right' },
    { id: 'giaTriBan', label: 'Giá trị bán', width: 140, visible: true, align: 'right' },
    { id: 'loaiNghiepVu', label: 'Loại nghiệp vụ', width: 140, visible: true, align: 'left' },
    { id: 'loaiHang', label: 'Loại hàng', width: 140, visible: true, align: 'left' },
    { id: 'ghiChuPhieuBan', label: 'Ghi chú phiếu bán hàng', width: 180, visible: true, align: 'left' },
    { id: 'ghiChuPhieuNhap', label: 'Ghi chú phiếu nhập hàng', width: 180, visible: true, align: 'left' },
    { id: 'description', label: 'Mô tả', width: 180, visible: true, align: 'left' },
    { id: 'customerCode', label: 'Mã khách hàng', width: 120, visible: true, align: 'left' },
    { id: 'volume', label: 'Số khối', width: 100, visible: true, align: 'right' },
    { id: 'weight', label: 'Số Kg', width: 100, visible: true, align: 'right' },
    { id: 'warehouse', label: 'Kho', width: 140, visible: true, align: 'left' },
    { id: 'qtyOriginal', label: 'SL theo đvt gốc', width: 120, visible: true, align: 'right' },
    { id: 'qtyConverted', label: 'quy đổi', width: 120, visible: true, align: 'right' },
  ];
  ...
  const totals = useMemo(() => {
    ...
    }), { quantity:0, giaNhap:0, giaTriNhap:0, tienVanChuyen:0, thanhTienVanChuyen:0, donBan:0, giaTriBan:0, inventoryBoxes: 0, saleValue: 0, endingBalance: 0, exportQty: 0, exportBoxes: 0, specification: 0, salePrice: 0, openingBalance: 0, importQty: 0, transferOut: 0, transferIn: 0, adjustment: 0, weight: 0, volume: 0, costPrice: 0, costValue: 0, qtyOriginal:0, qtyConverted:0 });
  }, [filteredData]);
  ...
  const numericColumns = ['quantity','giaNhap','giaTriNhap','tienVanChuyen','thanhTienVanChuyen','donBan','giaTriBan','inventoryBoxes', 'saleValue', 'endingBalance', 'exportQty', 'exportBoxes', 'specification', 'salePrice', 'openingBalance', 'importQty', 'transferOut', 'transferIn', 'adjustment', 'weight', 'volume', 'costPrice', 'costValue','qtyOriginal','qtyConverted'];
